...
load_model = r"/home/dell/af/Unimol_weights/HOMO/0822_dataset_load_oled"
data_file = r"/home/dell/af/测试/测试数据_1.csv"
save_file = r"/home/dell/af/测试/save_1.csv"
clf = MolPredict(load_model=load_model)
clf.predict(data=data_file,
            save_path=save_file)
