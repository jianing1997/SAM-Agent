...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.pos_emb = nn.Parameter(torch.zeros(1, config.block_size, config.n_embd)) # (1, 100, 256)
    ...
    def forward(self, idx, targets=None, prop = None, scaffold = None): # x, y, prop, sca_tensor
        b, t = idx.size()
